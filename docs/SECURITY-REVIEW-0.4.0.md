...
Final all-platform CI, final scanner results, and publication verification are pending. OpenCode history recommendations and Windows relocation stay unavailable; live Cursor access and manual VoiceOver acceptance are not claimed.
